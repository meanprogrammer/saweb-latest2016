...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function applydiagramsizepercentage(percentageId) {
            var percent = $('#' + percentageId).val();
            if (percent.replace(/\s/g, "") == "") {
                alert('Empty Percentage.');
                return;
            }
           
            var parsed = parseFloat(percent.trim());
            if (parsed == NaN) {
                alert('Invalid Value.');
                return;
            }
            ...
            $.ajax({
            type: "POST",
                url: "Ajax/resize.ashx?action=resize&percentage=" + parsed + "&id=" + $('#reportId').val(),
                complete: function(xhr, status) {
                    //console.log(xhr);
                },
                success: function(result) {
        ...
        function updatediagrampercentage(percentageId) {
            $.ajax({
                type: "POST",
                url: "Ajax/resize.ashx?action=save&percentage=" + $('#' + percentageId).val() + "&id=" + $('#reportId').val(),
                complete: function(xhr, status) {
                    //console.log(xhr);
                },
                success: function(result) {
                    if (result == "True") {
                        alert("Diagram resize success!");
                    } else {
                        alert("Diagram resize failed!");
                    }
                }
        ...
        <div class="tab-content top-margin-10">
            ...
            <div class="row">
                ...
                <div class="input-group" style="width: 250px">
                  <input id="newpercentage5" type="text" class="form-control input-sm show-inline" value="{{Diagram.Percentage}}" />
                  <div class="input-group-btn">
                    <input id="gopercentage5" name="gopercentage5" class="btn btn-primary btn-sm" onclick="applydiagramsizepercentage('newpercentage5');" type="button" value="Proceed" />
                    <input id="saveprocesspercent5" name="saveprocesspercent5" class="btn btn-primary btn-sm" onclick="updatediagrampercentage('newpercentage5');" type="button" value="Save" />
                  </div>
                </div>
    ...
    <script id="sysarch-content" type="text/x-handlebars-template">
        ...
        <div class="tab-content top-margin-10">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="input-group" style="width: 250px">
                            <input id="newpercentage4" type="text" class="form-control input-sm show-inline" value="{{Diagram.Percentage}}" />
                              <div class="input-group-btn">
                                <input id="gopercentage4" name="gopercentage4" class="btn btn-primary btn-sm" onclick="applydiagramsizepercentage('newpercentage4');" type="button" value="Proceed" />
                                <input id="saveprocesspercent4" name="saveprocesspercent4" class="btn btn-primary btn-sm" onclick="updatediagrampercentage('newpercentage4');" type="button" value="Save" />
                              </div>
                    </div>                               
                </div> 
                <div class="col-md-9">
         ...
         <div class="tab-content top-margin-10">
             ...
             <div class="tab-pane" id="diagram">
              ...
              <div class="row">
                    <div class="col-md-3">     
                        <div class="input-group" style="width: 250px">
                            <input id="newpercentage3" type="text" class="form-control input-sm show-inline" value="{{Diagram.Percentage}}" />
                              <div class="input-group-btn">
                                <input id="gopercentage3" name="gopercentage3" class="btn btn-primary btn-sm" onclick="applydiagramsizepercentage('newpercentage3');" type="button" value="Proceed" />
                                <input id="saveprocesspercent3" name="saveprocesspercent3" class="btn btn-primary btn-sm" onclick="updatediagrampercentage('newpercentage3');" type="button" value="Save" />
                              </div>
                        </div>  
                    </div> 
                    <div class="col-md-9">
    ...
    <script id="subprocess-content" type="text/x-handlebars-template">
        ...
        <div class="row">
            <div class="col-md-3">    
                <div class="input-group" style="width: 250px">
                    <input id="newpercentage2" type="text" class="form-control input-sm show-inline" value="{{Diagram.Percentage}}" />
                        <div class="input-group-btn">
                            <input id="gopercentage2" name="gopercentage2" class="btn btn-primary btn-sm" onclick="applydiagramsizepercentage('newpercentage2');" type="button" value="Proceed" />
                        <input id="saveprocesspercent2" name="saveprocesspercent2" class="btn btn-primary btn-sm" onclick="updatediagrampercentage('newpercentage2');" type="button" value="Save" />
                    </div>
                </div>                      
            </div> 
            <div class="col-md-9">
...
{{#if ShowResize}}
             <div class="col-md-3">             
                <div class="input-group" style="width: 250px">
                    <input id="newpercentage" type="text" class="form-control input-sm show-inline" value="{{Diagram.Percentage}}" />
                        <div class="input-group-btn">
                        <input id="gopercentage" name="gopercentage" class="btn btn-primary btn-sm" onclick="applydiagramsizepercentage('newpercentage');" type="button" value="Proceed" />
                        <input id="saveprocesspercent" name="saveprocesspercent" class="btn btn-primary btn-sm" onclick="updatediagrampercentage('newpercentage');" type="button" value="Save" />
                    </div>
                </div>
             </div> 
             <div class="col-md-5">
